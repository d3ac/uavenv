...
class UAVMoving(object):
    ...
    """
    def __init__(
        self, num_slaves=2, init_position=None, xlim=1000, ylim=1000, zlim_max=200, zlim_min=50, max_radius=30,
        master_velocity=10, slave_velocity=10, moving_factor=0.1, dt=0.1
    ):
        # 储存位置信息
    ...
    def init_position(self, init_potision=None):
